                      ...
                      >
                        ...
                        <ReactQuill
                          ...
                          className={clsx(
                            ...
                            {[classes.descInputFocusStyle]: desc_input_is_focused},
                          ...
                          defaultValue={''}
                          placeholder={t('createProject.inputs.description.placeholder')}
                          onChange={value => handleDescFieldChange(value, props, handleSetState)}
                          onFocus={() => handleDescFieldFocusChange(null, props, handleSetState)}
                        />
                        </ClickAwayListener>
                        <FormHelperText
                          error
                      ...
                      >
                        ...
                        <Select
                          ...
                          value={
                            ...
                            (publish_types[0] ? publish_types[0].value : '')
                          }
                        ...
                        <Box className={clsx(
                          ...
                          common_classes.marginTop1em,
                          {[common_classes.displayNone]: props.values.publish?.type !== publish_type["Preview"]}
                          )}>
                          {props.values.publish?.visible_to &&
                            props.values['publish']['visible_to'].map((username, num) =>
                              username ? (
                                <Chip
                                  className={classes.customChipStyle}
                                  key={num}
                                  label={username}
                                  onDelete={e => handleRemovePublishVisibleTo(e, props, username)}
                                  color="secondary"
                                  variant="outlined"
                                />
                              ) : null,
                          ...
                          <input
                            ...
                            type="text"
                            autocomplete="off"
                            placeholder={`${t('createProject.inputs.publish.addUsernames')}...`}
                            onChange={e => {
                              handleSuggestPublishVisibleTo(
                                e,
                                props,
                              ...
                              handleSetState(handleAddPublishVisibleTo(e, props));
                            }}
                            onBlur={e => {
                          ...
                          >
                            ...
                            >
                              {publish_visible_to_suggestion && publish_visible_to_suggestion.length > 0 ? (
                                publish_visible_to_suggestion.map((username, index) => (
                                  <Typography
                                    key={index}
                                    color="textPrimary"
                                    className={classes.tagSuggestionTextStyle}
