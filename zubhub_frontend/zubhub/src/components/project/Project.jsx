        ...
        <CardMedia className={classes.mediaBoxStyle} title={project.title}>
              ...
              >
                <Box className={classes.publishStyle}>
                  ...
                  {
                    project.publish.type === publish_type["Authenticated Creators"] ?
                    <LockIcon/> : ""
                  }
                  {
          ...
          >
            ...
            >
              <Box className={classes.creatorBoxStyle}>
                ...
                <Link className={common_classes.textDecorationNone} 
                to={`/search/?q=${project.creator.tags[0]}&tab=creators`}>
                  <Typography
                      className={clsx(
                        common_classes.baseTagStyle,{
                        [common_classes.extendedTagStyle]: !isBaseTag(project.creator.tags[0])
                      })}
                      component="h2"
                      >
